...
A comparative analysis revealed that the case-statement-based ALU resulted in slightly higher area and marginally increased timing performance, while the if–elseif-based ALU exhibited lower logic complexity and better delay due to sequential decision evaluation. Both designs, however, produced identical functional outputs.
